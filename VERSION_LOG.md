...
**Team:** 4 members — 蒋奕诚 (Lead), 金硕阳, 王嘉欣, 陆泉全
...
#### 蒋奕诚 (Yicheng Jiang) — Team Lead / Architecture / Integration
...
#### 王嘉欣 (Jiaxin Wang) — Dashboard / Frontend
...
#### 金硕阳 (Shuoyang Jin) — Data Analysis / Predictive Modeling
...
#### 陆泉全 (Quanquan Lu) — Narrative / Communication / Theory
